...
import cardimg1 from '../../assets/Images/LadiesBags/L1.webp';
import cardimghover1 from '../../assets/Images/LadiesBags/L1hover.webp';
import cardimg2 from '../../assets/Images/LadiesBags/L2.jpg';
import cardimghover2 from '../../assets/Images/LadiesBags/L2hover.jpg';
import cardimg3 from '../../assets/Images/LadiesBags/L3.jpg';
import cardimghover3 from '../../assets/Images/LadiesBags/L3hover.jpg';
import cardimg4 from '../../assets/Images/LadiesBags/L4.webp';
import cardimghover4 from '../../assets/Images/LadiesBags/L4hover.webp';
import cardimg5 from '../../assets/Images/LadiesBags/L5.webp';
import cardimghover5 from '../../assets/Images/LadiesBags/L5hover.webp';
import cardimg6 from '../../assets/Images/LadiesBags/L6.webp';
import cardimghover6 from '../../assets/Images/LadiesBags/L6hover.webp';
import cardimg7 from '../../assets/Images/LadiesBags/L7.webp';
import cardimghover7 from '../../assets/Images/LadiesBags/L7hover.webp';
...
const LadiesBags = () => {
  ...
  const productgets = response.data.getdata
     ...
     const ladiesbags = productgets.filter(
          (product) => product.category === 'ladiesbags'
        );
          setProducts(ladiesbags);
  ...
  return (
    <div>
      ...
      <div>
        <h1 className='text-center font-bold text-4xl p-4 text-[#303030] font-serif mt-10'>LADIES BAGS</h1>
        <p className='text-center  text-[#303030]'>
            Expertly designed from premium leather, to effortlessly hold all your essentials.
        </p>
